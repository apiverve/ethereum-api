...
namespace APIVerve.API.EthereumPrice
{
    ...
    /// <summary>
    /// Client for the EthereumPrice API
    /// </summary>
    public class EthereumPriceAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/ethereum";
        ...
        public EthereumPriceAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public EthereumPriceAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public EthereumPriceAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, EthereumPriceQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(EthereumPriceQueryOptions options)
        {
        ...
        public ResponseObj Execute(EthereumPriceQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(EthereumPriceQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(EthereumPriceQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(EthereumPriceQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(EthereumPriceQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(EthereumPriceQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(EthereumPriceQueryOptions options)
        {
