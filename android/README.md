...
```gradle
dependencies {
    implementation 'com.github.apiverve:ethereum-api:1.1.14'
}
```
...
```java
import com.apiverve.ethereum.EthereumPriceAPIClient;
import com.apiverve.ethereum.APIResponse;
import com.apiverve.ethereum.APIException;

// Initialize the client
EthereumPriceAPIClient client = new EthereumPriceAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/ethereum](https://docs.apiverve.com/ref/ethereum)
...
- **Documentation:** [https://docs.apiverve.com/ref/ethereum](https://docs.apiverve.com/ref/ethereum)
- **Issues:** [GitHub Issues](https://github.com/apiverve/ethereum-api/issues)
