...
/**
 * Client for the Ethereum Price API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://ethereum.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/ethereum';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\EthereumClient] {$message}\n";
        }
    }
}
