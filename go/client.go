// Package ethereum provides a Go client for the Ethereum Price API.
//
// For more information, visit: https://apiverve.com/marketplace/ethereum?utm_source=go&utm_medium=readme
package ethereum
...
const (
	baseURL        = "https://api.apiverve.com/v1/ethereum"
	defaultTimeout = 30 * time.Second
)

// Client is the Ethereum Price API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Ethereum Price API client.
...
// Execute makes a request to the Ethereum Price API with typed parameters.
//
